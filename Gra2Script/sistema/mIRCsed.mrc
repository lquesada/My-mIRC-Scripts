...
;
; Versión especial para Gra2 Script.
;
;---------------
; A tener en cuenta:
; [-]  Este addon utiliza el sistema de encriptado de ais con su pleno consentimiento.
; [-]  Para enviar texto encriptado SIN CONTRASEÑA a la ventana actual: /cr texto.
; [-]  Para enviar texto encriptado CON CONTRASEÑA tienes que haberla 
; definido en /sedkeys y escribes /kr texto
; [-]  El resto del addon se puede controlar con los popups en los privados, canales...
; [-]  Necesitas tener crypt.dll en el mismo directorio que el addon.
; [-]  El texto encriptado SIN CONTRASEÑA por este addon será leido por toda la gente
; que lo use, y que reciba el mensaje encriptado.
;---------------
...
alias -l crt .msg $1 $dll($scriptdirdll\crypt.dll,crypt,$$2-) | echo 4 -qa $timestamp [cr] - $1 -> $$2-
...
alias -l _.crloc return $shortfn($scriptdirdll\crypt.dll)
